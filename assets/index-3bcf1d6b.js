 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fk={["no-app"]:"No Firebase App '{$appName}' has been created - call initializeApp() first",["bad-app-name"]:"Illegal App name: '{$appName}",["duplicate-app"]:"Firebase App named '{$appName}' already exists with different options or config",["app-deleted"]:"Firebase App named '{$appName}' already deleted",["no-options"]:"Need to provide options, when not being deployed to hosting via source.",["invalid-app-argument"]:"firebase.{$appName}() takes either no argument or a Firebase App instance.",["invalid-log-argument"]:"First argument to `onLog` must be null or a function.",["idb-open"]:"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.",["idb-get"]:"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.",["idb-set"]:"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.",["idb-delete"]:"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},In=new Zr("app","Firebase",Fk);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yr=Ak;function Yh(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:lr,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw In.create("bad-app-name",{appName:String(i)});if(n||(n=cy()),!n)throw In.create("no-options");const s=ur.get(i);if(s){if(hl(n,s.options)&&hl(r,s.config))return s;throw In.create("duplicate-app",{appName:i})}const o=new $T(i);for(const l of go.values())o.addComponent(l);const a=new Uk(n,r,o);return ur.set(i,a),a}function Qh(t=lr){const e=ur.get(t);if(!e&&t===lr&&cy())return Yh();if(!e)throw In.create("no-app",{appName:t});return e}function jk(){return Array.from(ur.values())}async function Iy(t){const e=t.name;ur.has(e)&&(ur.delete(e),await Promise.all(t.container.getProviders().map(n=>n.delete())),t.isDeleted=!0)}function hn(t,e,n){var r;let i=(r=Lk[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Hr.warn(a.join(" "));return}cr(new Nn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}function Cy(t,e){if(t!==null&&typeof t!="function")throw In.create("invalid-log-argument");YT(t,e)}function Sy(t){qT(t)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zk="firebase-heartbeat-database",Wk=1,vo="firebase-heartbeat-store";let nc=null;function Ty(){return nc||(nc=ik(zk,Wk,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(vo)}}}).catch(t=>{throw In.create("idb-open",{originalErrorMessage:t.message})})),nc}async function Bk(t){try{return await(await Ty()).transaction(vo).objectStore(vo).get(ky(t))}catch(e){if(e instanceof _t)Hr.warn(e.message);else{const n=In.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Hr.warn(n.message)}}}async function Im(t,e){try{const r=(await Ty()).transaction(vo,"readwrite");await r.objectStore(vo).put(e,ky(t)),await r.done}catch(n){if(n instanceof _t)Hr.warn(n.message);else{const r=In.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Hr.warn(r.message)}}}function ky(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bn(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof _t&&y1(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function y1({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ic(t,e){return Ln(t,"POST","/v1/accounts:signInWithPassword",De(t,e))}async function ru(t,e){return ze(t,"POST","/v1/accounts:sendOobCode",De(t,e))}async function W1(t,e){return ru(t,e)}async function sc(t,e){return ru(t,e)}async function oc(t,e){return ru(t,e)}async function B1(t,e){return ru(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function H1(t,e){return Ln(t,"POST","/v1/accounts:signInWithEmailLink",De(t,e))}async function $1(t,e){return Ln(t,"POST","/v1/accounts:signInWithEmailLink",De(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zy(t,e,n=!1){const{auth:r}=t,i="reauthenticate";try{const s=await bn(t,Jy(r,i,e,t),n);b(s.idToken,r,"internal-error");const o=nu(s.idToken);b(o,r,"internal-error");const{sub:a}=o;return b(t.uid===a,r,"user-mismatch"),Ft._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&Ge(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rR(t,e){return Ln(t,"POST","/v1/accounts:signInWithCustomToken",De(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yR(t,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const r=$(t),s={idToken:await r.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},o=await bn(r,_R(r.auth,s));r.displayName=o.displayName||null,r.photoURL=o.photoUrl||null;const a=r.providerData.find(({providerId:l})=>l==="password");a&&(a.displayName=r.displayName,a.photoURL=r.photoURL),await r._updateTokensIfNecessary(o)}function wR(t,e){return i0($(t),e,null)}function ER(t,e){return i0($(t),null,e)}async function i0(t,e,n){const{auth:r}=t,s={idToken:await t.getIdToken(),returnSecureToken:!0};e&&(s.email=e),n&&(s.password=n);const o=await bn(t,Qy(r,s));await t._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uN(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function cN(t){cr(new Nn("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=r.options;b(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:By(t)},u=new D1(r,i,s,l);return F1(u,n),u},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),cr(new Nn("auth-internal",e=>{const n=be(e.getProvider("auth").getImmediate());return(r=>new lN(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),hn(zm,Wm,uN(t)),hn(zm,Wm,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ib{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,n){n==null?delete this.cache_[e]:this.cache_[e]=n}get(e){return Jt(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A0=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Eb(e)}}catch{}return new Ib},br=A0("localStorage"),xd=A0("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bi=new tu("@firebase/database"),Cb=function(){let t=1;return function(){return t++}}(),L0=function(t){const e=zT(t),n=new FT;n.update(e);const r=n.digest();return $h.encodeByteArray(r)},Ho=function(...t){let e="";for(let n=0;n<t.length;n++){const r=t[n];Array.isArray(r)||r&&typeof r=="object"&&typeof r.length=="number"?e+=Ho.apply(null,r):typeof r=="object"?e+=Ve(r):e+=r,e+=" "}return e};let Fr=null,Jm=!0;const Sb=function(t,e){x(!e||t===!0||t===!1,"Can't turn on custom loggers persistently."),t===!0?(bi.logLevel=ue.VERBOSE,Fr=bi.log.bind(bi),e&&xd.set("logging_enabled",!0)):typeof t=="function"?Fr=t:(Fr=null,xd.remove("logging_enabled"))},rt=function(...t){if(Jm===!0&&(Jm=!1,Fr===null&&xd.get("logging_enabled")===!0&&Sb(!0)),Fr){const e=Ho.apply(null,t);Fr(e)}},$o=function(t){return function(...e){rt(t,...e)}},Od=function(...t){const e="FIREBASE INTERNAL ERROR: "+Ho(...t);bi.error(e)},xn=function(...t){const e=`FIREBASE FATAL ERROR: ${Ho(...t)}`;throw bi.error(e),new Error(e)},yt=function(...t){const e="FIREBASE WARNING: "+Ho(...t);bi.warn(e)},Tb=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&yt("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},D0=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},kb=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},Vi="[MIN_NAME]",Gr="[MAX_NAME]",ss=function(t,e){if(t===e)return 0;if(t===Vi||e===Gr)return-1;if(e===Vi||t===Gr)return 1;{const n=Xm(t),r=Xm(e);return n!==null?r!==null?n-r===0?t.length-e.length:n-r:-1:r!==null?1:t<e?-1:1}},Rb=function(t,e){return t===e?0:t<e?-1:1},ys=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+Ve(e))},vf=function(t){if(typeof t!="object"||t===null)return Ve(t);const e=[];for(const r in t)e.push(r);e.sort();let n="{";for(let r=0;r<e.length;r++)r!==0&&(n+=","),n+=Ve(e[r]),n+=":",n+=vf(t[e[r]]);return n+="}",n},M0=function(t,e){const n=t.length;if(n<=e)return[t];const r=[];for(let i=0;i<n;i+=e)i+e>n?r.push(t.substring(i,n)):r.push(t.substring(i,i+e));return r};function wt(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const F0=function(t){x(!D0(t),"Invalid JSON number");const e=11,n=52,r=(1<<e-1)-1;let i,s,o,a,l;t===0?(s=0,o=0,i=1/t===-1/0?1:0):(i=t<0,t=Math.abs(t),t>=Math.pow(2,1-r)?(a=Math.min(Math.floor(Math.log(t)/Math.LN2),r),s=a+r,o=Math.round(t*Math.pow(2,n-a)-Math.pow(2,n))):(s=0,o=Math.round(t/Math.pow(2,1-r-n))));const u=[];for(l=n;l;l-=1)u.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)u.push(s%2?1:0),s=Math.floor(s/2);u.push(i?1:0),u.reverse();const c=u.join("");let d="";for(l=0;l<64;l+=8){let h=parseInt(c.substr(l,8),2).toString(16);h.length===1&&(h="0"+h),d=d+h}return d.toLowerCase()},Pb=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},Nb=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function bb(t,e){let n="Unknown Error";t==="too_big"?n="The data requested exceeds the maximum size that can be accessed with a single request.":t==="permission_denied"?n="Client doesn't have permission to access the desired data.":t==="unavailable"&&(n="The service is unavailable");const r=new Error(t+" at "+e._path.toString()+": "+n);return r.code=t.toUpperCase(),r}const xb=new RegExp("^-?(0*)\\d{1,10}$"),Ob=-2147483648,Ab=2147483647,Xm=function(t){if(xb.test(t)){const e=Number(t);if(e>=Ob&&e<=Ab)return e}return null},os=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw yt("Exception was thrown by user callback.",n),e},Math.floor(0))}},Lb=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},$s=function(t,e){const n=setTimeout(t,e);return typeof n=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(n):typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Db{constructor(e,n){this.appName_=e,this.appCheckProvider=n,this.appCheck=n==null?void 0:n.getImmediate({optional:!0}),this.appCheck||n==null||n.get().then(r=>this.appCheck=r)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((n,r)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(n,r):n(null)},0)})}addTokenChangeListener(e){var n;(n=this.appCheckProvider)===null||n===void 0||n.get().then(r=>r.addTokenListener(e))}notifyForInvalidToken(){yt(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mb{constructor(e,n,r){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=r,this.auth_=null,this.auth_=r.getImmediate({optional:!0}),this.auth_||r.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(rt("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,r)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,r):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',yt(e)}}class xi{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}xi.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ub{constructor(){this.counters_={}}incrementCounter(e,n=1){Jt(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=n}get(){return IT(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pc={},mc={};function yf(t){const e=t.toString();return pc[e]||(pc[e]=new Ub),pc[e]}function jb(t,e){const n=t.toString();return mc[n]||(mc[n]=e()),mc[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zm="start",Wb="close",Bb="pLPCommand",Hb="pRTLPCB",Y0="id",Q0="pw",J0="ser",$b="cb",Vb="seg",Kb="ts",Gb="d",qb="dframe",X0=1870,Z0=30,Yb=X0-Z0,Qb=25e3,Jb=3e4;class yi{constructor(e,n,r,i,s,o,a){this.connId=e,this.repoInfo=n,this.applicationId=r,this.appCheckToken=i,this.authToken=s,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=$o(e),this.stats_=yf(n),this.urlFn=l=>(this.appCheckToken&&(l[Ad]=this.appCheckToken),q0(n,K0,l))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new zb(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(Jb)),kb(()=>{if(this.isClosed_)return;this.scriptTagHolder=new wf((...s)=>{const[o,a,l,u,c]=s;if(this.incrementIncomingBytes_(s),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===Zm)this.id=a,this.password=l;else if(o===Wb)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...s)=>{const[o,a]=s;this.incrementIncomingBytes_(s),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const r={};r[Zm]="t",r[J0]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(r[$b]=this.scriptTagHolder.uniqueCallbackIdentifier),r[U0]=_f,this.transportSessionId&&(r[j0]=this.transportSessionId),this.lastSessionId&&(r[H0]=this.lastSessionId),this.applicationId&&(r[$0]=this.applicationId),this.appCheckToken&&(r[Ad]=this.appCheckToken),typeof location<"u"&&location.hostname&&B0.test(location.hostname)&&(r[z0]=W0);const i=this.urlFn(r);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){yi.forceAllow_=!0}static forceDisallow(){yi.forceDisallow_=!0}static isAvailable(){return yi.forceAllow_?!0:!yi.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!Pb()&&!Nb()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=Ve(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const r=ly(n),i=M0(r,Yb);for(let s=0;s<i.length;s++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[s]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const r={};r[qb]="t",r[Y0]=e,r[Q0]=n,this.myDisconnFrame.src=this.urlFn(r),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=Ve(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class wf{constructor(e,n,r,i){this.onDisconnect=r,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=Cb(),window[Bb+this.uniqueCallbackIdentifier]=e,window[Hb+this.uniqueCallbackIdentifier]=n,this.myIFrame=wf.createIFrame_();let s="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(s='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+s+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){rt("frame writing exception"),a.stack&&rt(a.stack),rt(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||rt("No IE domain setting required")}catch{const r=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+r+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Y0]=this.myID,e[Q0]=this.myPW,e[J0]=this.currentSerial;let n=this.urlFn(e),r="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Z0+r.length<=X0;){const o=this.pendingSegs.shift();r=r+"&"+Vb+i+"="+o.seg+"&"+Kb+i+"="+o.ts+"&"+Gb+i+"="+o.d,i++}return n=n+r,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,r){this.pendingSegs.push({seg:e,ts:n,d:r}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const r=()=>{this.outstandingRequests.delete(n),this.newRequest_()},i=setTimeout(r,Math.floor(Qb)),s=()=>{clearTimeout(i),r()};this.addTag(e,s)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const r=this.myIFrame.doc.createElement("script");r.type="text/javascript",r.async=!0,r.src=e,r.onload=r.onreadystatechange=function(){const i=r.readyState;(!i||i==="loaded"||i==="complete")&&(r.onload=r.onreadystatechange=null,r.parentNode&&r.parentNode.removeChild(r),n())},r.onerror=()=>{rt("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(r)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vx(t,e){return ss(t.name,e.name)}function Cf(t,e){return ss(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ld;function _x(t){Ld=t}const aw=function(t){return typeof t=="number"?"number:"+F0(t):"string:"+t},lw=function(t){if(t.isLeafNode()){const e=t.val();x(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Jt(e,".sv"),"Priority must be a string or number.")}else x(t===Ld||t.isEmpty(),"priority of unexpected type.");x(t===Ld||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let uw,cw;function yx(t){uw=t}function wx(t){cw=t}class Ex extends pu{compare(e,n){const r=e.node.getPriority(),i=n.node.getPriority(),s=r.compareTo(i);return s===0?ss(e.name,n.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return q.MIN}maxPost(){return new q(Gr,new Be("[PRIORITY-POST]",cw))}makePost(e,n){const r=uw(e);return new q(n,new Be("[PRIORITY-POST]",r))}toString(){return".priority"}}const ke=new Ex;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ix=Math.log(2);class Cx{constructor(e){const n=s=>parseInt(Math.log(s)/Ix,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Il=function(t,e,n,r){t.sort(e);const i=function(l,u){const c=u-l;let d,h;if(c===0)return null;if(c===1)return d=t[l],h=n?n(d):d,new $e(h,d.node,$e.BLACK,null,null);{const m=parseInt(c/2,10)+l,v=i(l,m),y=i(m+1,u);return d=t[m],h=n?n(d):d,new $e(h,d.node,$e.BLACK,v,y)}},s=function(l){let u=null,c=null,d=t.length;const h=function(v,y){const w=d-v,p=d;d-=v;const f=i(w+1,p),g=t[w],_=n?n(g):g;m(new $e(_,g.node,y,null,f))},m=function(v){u?(u.left=v,u=v):(c=v,u=v)};for(let v=0;v<l.count;++v){const y=l.nextBitIsOne(),w=Math.pow(2,l.count-(v+1));y?h(w,$e.BLACK):(h(w,$e.BLACK),h(w,$e.RED))}return c},o=new Cx(t.length),a=s(o);return new pt(r||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tx=!0;function Ye(t,e=null){if(t===null)return H.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),x(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new Be(n,Ye(e))}if(!(t instanceof Array)&&Tx){const n=[];let r=!1;if(wt(t,(o,a)=>{if(o.substring(0,1)!=="."){const l=Ye(a);l.isEmpty()||(r=r||!l.getPriority().isEmpty(),n.push(new q(o,l)))}}),n.length===0)return H.EMPTY_NODE;const s=Il(n,vx,o=>o.name,Cf);if(r){const o=Il(n,ke.getCompare());return new H(s,Ye(e),new wn({".priority":o},{".priority":ke}))}else return new H(s,Ye(e),wn.Default)}else{let n=H.EMPTY_NODE;return wt(t,(r,i)=>{if(Jt(t,r)&&r.substring(0,1)!=="."){const s=Ye(i);(s.isLeafNode()||!s.isEmpty())&&(n=n.updateImmediateChild(r,s))}}),n.updatePriority(Ye(e))}}yx(Ye);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rx extends pu{compare(e,n){const r=e.node.compareTo(n.node);return r===0?ss(e.name,n.name):r}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return q.MIN}maxPost(){return q.MAX}makePost(e,n){const r=Ye(e);return new q(n,r)}toString(){return".value"}}const Px=new Rx;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ox{constructor(){this.rootNode_=H.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,n){this.rootNode_=this.rootNode_.updateChild(e,n)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lx{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n=Object.assign({},e);return this.last_&&wt(this.last_,(r,i)=>{n[r]=n[r]-i}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fg=10*1e3,Dx=30*1e3,Mx=5*60*1e3;class Fx{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new Lx(e);const r=fg+(Dx-fg)*Math.random();$s(this.reportStats_.bind(this),Math.floor(r))}reportStats_(){const e=this.statsListener_.get(),n={};let r=!1;wt(e,(i,s)=>{s>0&&Jt(this.statsToReport_,i)&&(n[i]=s,r=!0)}),r&&this.server_.reportStats(n),$s(this.reportStats_.bind(this),Math.floor(Math.random()*2*Mx))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ux{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function jx(t,e,n,r){const i=[],s=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&s.push(Nx(o.childName,o.snapshotNode))}),Is(t,i,"child_removed",e,r,n),Is(t,i,"child_added",e,r,n),Is(t,i,"child_moved",s,r,n),Is(t,i,"child_changed",e,r,n),Is(t,i,"value",e,r,n),i}function Is(t,e,n,r,i,s){const o=r.filter(a=>a.type===n);o.sort((a,l)=>Wx(t,a,l)),o.forEach(a=>{const l=zx(t,a,s);i.forEach(u=>{u.respondsTo(a.type)&&e.push(u.createEvent(l,t.query_))})})}function zx(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function Wx(t,e,n){if(e.childName==null||n.childName==null)throw es("Should only compare child_ events.");const r=new q(e.childName,e.snapshotNode),i=new q(n.childName,n.snapshotNode);return t.index_.compare(r,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pf(t,e){return yw(e,t)}function Hx(t,e,n,r,i){x(r>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:r,visible:i}),i&&(t.visibleWrites=Ks(t.visibleWrites,e,n)),t.lastWriteId=r}function $x(t,e){for(let n=0;n<t.allWrites.length;n++){const r=t.allWrites[n];if(r.writeId===e)return r}return null}function Vx(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);x(n>=0,"removeWrite called with nonexistent writeId.");const r=t.allWrites[n];t.allWrites.splice(n,1);let i=r.visible,s=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&Kx(a,r.path)?i=!1:Vt(r.path,a.path)&&(s=!0)),o--}if(i){if(s)return Gx(t),!0;if(r.snap)t.visibleWrites=mg(t.visibleWrites,r.path);else{const a=r.children;wt(a,l=>{t.visibleWrites=mg(t.visibleWrites,Ue(r.path,l))})}return!0}else return!1}function Kx(t,e){if(t.snap)return Vt(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Vt(Ue(t.path,n),e))return!0;return!1}function Gx(t){t.visibleWrites=gw(t.allWrites,qx,oe()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function qx(t){return t.visible}function gw(t,e,n){let r=Yt.empty();for(let i=0;i<t.length;++i){const s=t[i];if(e(s)){const o=s.path;let a;if(s.snap)Vt(n,o)?(a=ft(n,o),r=Ks(r,a,s.snap)):Vt(o,n)&&(a=ft(o,n),r=Ks(r,oe(),s.snap.getChild(a)));else if(s.children){if(Vt(n,o))a=ft(n,o),r=pg(r,a,s.children);else if(Vt(o,n))if(a=ft(o,n),Q(a))r=pg(r,oe(),s.children);else{const l=Wi(s.children,G(a));if(l){const u=l.getChild(me(a));r=Ks(r,oe(),u)}}}else throw es("WriteRecord should have .snap or .children")}}return r}function vw(t,e,n,r,i){if(!r&&!i){const s=ni(t.visibleWrites,e);if(s!=null)return s;{const o=sr(t.visibleWrites,e);if(Ud(o))return n;if(n==null&&!Fd(o,oe()))return null;{const a=n||H.EMPTY_NODE;return Gi(o,a)}}}else{const s=sr(t.visibleWrites,e);if(!i&&Ud(s))return n;if(!i&&n==null&&!Fd(s,oe()))return null;{const o=function(u){return(u.visible||i)&&(!r||!~r.indexOf(u.writeId))&&(Vt(u.path,e)||Vt(e,u.path))},a=gw(t.allWrites,o,e),l=n||H.EMPTY_NODE;return Gi(a,l)}}}function Yx(t,e,n){let r=H.EMPTY_NODE;const i=ni(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(ke,(s,o)=>{r=r.updateImmediateChild(s,o)}),r;if(n){const s=sr(t.visibleWrites,e);return n.forEachChild(ke,(o,a)=>{const l=Gi(sr(s,new fe(o)),a);r=r.updateImmediateChild(o,l)}),gg(s).forEach(o=>{r=r.updateImmediateChild(o.name,o.node)}),r}else{const s=sr(t.visibleWrites,e);return gg(s).forEach(o=>{r=r.updateImmediateChild(o.name,o.node)}),r}}function Qx(t,e,n,r,i){x(r||i,"Either existingEventSnap or existingServerSnap must exist");const s=Ue(e,n);if(Fd(t.visibleWrites,s))return null;{const o=sr(t.visibleWrites,s);return Ud(o)?i.getChild(n):Gi(o,i.getChild(n))}}function Jx(t,e,n,r){const i=Ue(e,n),s=ni(t.visibleWrites,i);if(s!=null)return s;if(r.isCompleteForChild(n)){const o=sr(t.visibleWrites,i);return Gi(o,r.getNode().getImmediateChild(n))}else return null}function Xx(t,e){return ni(t.visibleWrites,e)}function Zx(t,e,n,r,i,s,o){let a;const l=sr(t.visibleWrites,e),u=ni(l,oe());if(u!=null)a=u;else if(n!=null)a=Gi(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const c=[],d=o.getCompare(),h=s?a.getReverseIteratorFrom(r,o):a.getIteratorFrom(r,o);let m=h.getNext();for(;m&&c.length<i;)d(m,r)!==0&&c.push(m),m=h.getNext();return c}else return[]}function eO(){return{visibleWrites:Yt.empty(),allWrites:[],lastWriteId:-1}}function kl(t,e,n,r){return vw(t.writeTree,t.treePath,e,n,r)}function Nf(t,e){return Yx(t.writeTree,t.treePath,e)}function vg(t,e,n,r){return Qx(t.writeTree,t.treePath,e,n,r)}function Rl(t,e){return Xx(t.writeTree,Ue(t.treePath,e))}function tO(t,e,n,r,i,s){return Zx(t.writeTree,t.treePath,e,n,r,i,s)}function bf(t,e,n){return Jx(t.writeTree,t.treePath,e,n)}function _w(t,e){return yw(Ue(t.treePath,e),t.writeTree)}function yw(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rO{getCompleteChild(e){return null}getChildAfterChild(e,n,r){return null}}const ww=new rO;class xf{constructor(e,n,r=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=r}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const r=this.optCompleteServerCache_!=null?new Yr(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return bf(this.writes_,e,r)}}getChildAfterChild(e,n,r){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Qr(this.viewCache_),s=tO(this.writes_,i,n,1,r,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Nl;class vO{constructor(){this.views=new Map}}function _O(t){x(!Nl,"__referenceConstructor has already been defined"),Nl=t}function yO(){return x(Nl,"Reference.ts has not been loaded"),Nl}function wO(t){return t.views.size===0}function Of(t,e,n,r){const i=e.source.queryId;if(i!==null){const s=t.views.get(i);return x(s!=null,"SyncTree gave us an op for an invalid query."),Ig(s,e,n,r)}else{let s=[];for(const o of t.views.values())s=s.concat(Ig(o,e,n,r));return s}}function EO(t,e,n,r,i){const s=e._queryIdentifier,o=t.views.get(s);if(!o){let a=kl(n,i?r:null),l=!1;a?l=!0:r instanceof H?(a=Nf(n,r),l=!1):(a=H.EMPTY_NODE,l=!1);const u=mu(new Yr(a,l,!1),new Yr(r,i,!1));return new hO(e,u)}return o}function IO(t,e,n,r,i,s){const o=EO(t,e,r,i,s);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),mO(o,n),gO(o,n)}function CO(t,e,n,r){const i=e._queryIdentifier,s=[];let o=[];const a=pr(t);if(i==="default")for(const[l,u]of t.views.entries())o=o.concat(Eg(u,n,r)),wg(u)&&(t.views.delete(l),u.query._queryParams.loadsAllData()||s.push(u.query));else{const l=t.views.get(i);l&&(o=o.concat(Eg(l,n,r)),wg(l)&&(t.views.delete(i),l.query._queryParams.loadsAllData()||s.push(l.query)))}return a&&!pr(t)&&s.push(new(yO())(e._repo,e._path)),{removed:s,events:o}}function Cw(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Ai(t,e){let n=null;for(const r of t.views.values())n=n||pO(r,e);return n}function Sw(t,e){if(e._queryParams.loadsAllData())return gu(t);{const r=e._queryIdentifier;return t.views.get(r)}}function Tw(t,e){return Sw(t,e)!=null}function pr(t){return gu(t)!=null}function gu(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bl;function SO(t){x(!bl,"__referenceConstructor has already been defined"),bl=t}function TO(){return x(bl,"Reference.ts has not been loaded"),bl}let kO=1;class Cg{constructor(e){this.listenProvider_=e,this.syncPointTree_=new _e(null),this.pendingWriteTree_=eO(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function kw(t,e,n,r,i){return Hx(t.pendingWriteTree_,e,n,r,i),i?Ko(t,new qr(fw(),e,n)):[]}function xr(t,e,n=!1){const r=$x(t.pendingWriteTree_,e);if(Vx(t.pendingWriteTree_,e)){let s=new _e(null);return r.snap!=null?s=s.set(oe(),!0):wt(r.children,o=>{s=s.set(new fe(o),!0)}),Ko(t,new Tl(r.path,s,n))}else return[]}function vu(t,e,n){return Ko(t,new qr(kf(),e,n))}function RO(t,e,n){const r=_e.fromObject(n);return Ko(t,new Po(kf(),e,r))}function PO(t,e){return Ko(t,new Ro(kf(),e))}function NO(t,e,n){const r=Lf(t,n);if(r){const i=Df(r),s=i.path,o=i.queryId,a=ft(s,e),l=new Ro(Rf(o),a);return Mf(t,s,l)}else return[]}function Wd(t,e,n,r,i=!1){const s=e._path,o=t.syncPointTree_.get(s);let a=[];if(o&&(e._queryIdentifier==="default"||Tw(o,e))){const l=CO(o,e,n,r);wO(o)&&(t.syncPointTree_=t.syncPointTree_.remove(s));const u=l.removed;if(a=l.events,!i){const c=u.findIndex(h=>h._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(s,(h,m)=>pr(m));if(c&&!d){const h=t.syncPointTree_.subtree(s);if(!h.isEmpty()){const m=OO(h);for(let v=0;v<m.length;++v){const y=m[v],w=y.query,p=Nw(t,y);t.listenProvider_.startListening(Gs(w),xl(t,w),p.hashFn,p.onComplete)}}}!d&&u.length>0&&!r&&(c?t.listenProvider_.stopListening(Gs(e),null):u.forEach(h=>{const m=t.queryToTagMap.get(_u(h));t.listenProvider_.stopListening(Gs(h),m)}))}AO(t,u)}return a}function bO(t,e,n,r){const i=Lf(t,r);if(i!=null){const s=Df(i),o=s.path,a=s.queryId,l=ft(o,e),u=new qr(Rf(a),l,n);return Mf(t,o,u)}else return[]}function xO(t,e,n,r){const i=Lf(t,r);if(i){const s=Df(i),o=s.path,a=s.queryId,l=ft(o,e),u=_e.fromObject(n),c=new Po(Rf(a),l,u);return Mf(t,o,c)}else return[]}function Sg(t,e,n,r=!1){const i=e._path;let s=null,o=!1;t.syncPointTree_.foreachOnPath(i,(h,m)=>{const v=ft(h,i);s=s||Ai(m,v),o=o||pr(m)});let a=t.syncPointTree_.get(i);a?(o=o||pr(a),s=s||Ai(a,oe())):(a=new vO,t.syncPointTree_=t.syncPointTree_.set(i,a));let l;s!=null?l=!0:(l=!1,s=H.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((m,v)=>{const y=Ai(v,oe());y&&(s=s.updateImmediateChild(m,y))}));const u=Tw(a,e);if(!u&&!e._queryParams.loadsAllData()){const h=_u(e);x(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const m=LO();t.queryToTagMap.set(h,m),t.tagToQueryMap.set(m,h)}const c=Pf(t.pendingWriteTree_,i);let d=IO(a,e,n,c,s,l);if(!u&&!o&&!r){const h=Sw(a,e);d=d.concat(DO(t,e,h))}return d}function Af(t,e,n){const i=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=ft(o,e),u=Ai(a,l);if(u)return u});return vw(i,e,s,n,!0)}function Ko(t,e){return Rw(e,t.syncPointTree_,null,Pf(t.pendingWriteTree_,oe()))}function Rw(t,e,n,r){if(Q(t.path))return Pw(t,e,n,r);{const i=e.get(oe());n==null&&i!=null&&(n=Ai(i,oe()));let s=[];const o=G(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const u=n?n.getImmediateChild(o):null,c=_w(r,o);s=s.concat(Rw(a,l,u,c))}return i&&(s=s.concat(Of(i,t,r,n))),s}}function Pw(t,e,n,r){const i=e.get(oe());n==null&&i!=null&&(n=Ai(i,oe()));let s=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,u=_w(r,o),c=t.operationForChild(o);c&&(s=s.concat(Pw(c,a,l,u)))}),i&&(s=s.concat(Of(i,t,r,n))),s}function Nw(t,e){const n=e.query,r=xl(t,n);return{hashFn:()=>(fO(e)||H.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return r?NO(t,n._path,r):PO(t,n._path);{const s=bb(i,n);return Wd(t,n,null,s)}}}}function xl(t,e){const n=_u(e);return t.queryToTagMap.get(n)}function _u(t){return t._path.toString()+"$"+t._queryIdentifier}function Lf(t,e){return t.tagToQueryMap.get(e)}function Df(t){const e=t.indexOf("$");return x(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new fe(t.substr(0,e))}}function Mf(t,e,n){const r=t.syncPointTree_.get(e);x(r,"Missing sync point for query tag that we're tracking");const i=Pf(t.pendingWriteTree_,e);return Of(r,n,i,null)}function OO(t){return t.fold((e,n,r)=>{if(n&&pr(n))return[gu(n)];{let i=[];return n&&(i=Cw(n)),wt(r,(s,o)=>{i=i.concat(o)}),i}})}function Gs(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(TO())(t._repo,t._path):t}function AO(t,e){for(let n=0;n<e.length;++n){const r=e[n];if(!r._queryParams.loadsAllData()){const i=_u(r),s=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(s)}}}function LO(){return kO++}function DO(t,e,n){const r=e._path,i=xl(t,e),s=Nw(t,n),o=t.listenProvider_.startListening(Gs(e),i,s.hashFn,s.onComplete),a=t.syncPointTree_.subtree(r);if(i)x(!pr(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((u,c,d)=>{if(!Q(u)&&c&&pr(c))return[gu(c).query];{let h=[];return c&&(h=h.concat(Cw(c).map(m=>m.query))),wt(d,(m,v)=>{h=h.concat(v)}),h}});for(let u=0;u<l.length;++u){const c=l[u];t.listenProvider_.stopListening(Gs(c),xl(t,c))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zf{constructor(e="",n=null,r={children:{},childCount:0}){this.name=e,this.parent=n,this.node=r}}function Wf(t,e){let n=e instanceof fe?e:new fe(e),r=t,i=G(n);for(;i!==null;){const s=Wi(r.node.children,i)||{children:{},childCount:0};r=new zf(i,r,s),n=me(n),i=G(n)}return r}function as(t){return t.node.value}function xw(t,e){t.node.value=e,Bd(t)}function Ow(t){return t.node.childCount>0}function zO(t){return as(t)===void 0&&!Ow(t)}function yu(t,e){wt(t.node.children,(n,r)=>{e(new zf(n,t,r))})}function Aw(t,e,n,r){n&&!r&&e(t),yu(t,i=>{Aw(i,e,!0,r)}),n&&r&&e(t)}function WO(t,e,n){let r=n?t:t.parent;for(;r!==null;){if(e(r))return!0;r=r.parent}return!1}function Go(t){return new fe(t.parent===null?t.name:Go(t.parent)+"/"+t.name)}function Bd(t){t.parent!==null&&BO(t.parent,t.name,t)}function BO(t,e,n){const r=zO(n),i=Jt(t.node.children,e);r&&i?(delete t.node.children[e],t.node.childCount--,Bd(t)):!r&&!i&&(t.node.children[e]=n.node,t.node.childCount++,Bd(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HO=/[\[\].#$\/\u0000-\u001F\u007F]/,$O=/[\[\].#$\u0000-\u001F\u007F]/,yc=10*1024*1024,Lw=function(t){return typeof t=="string"&&t.length!==0&&!HO.test(t)},Dw=function(t){return typeof t=="string"&&t.length!==0&&!$O.test(t)},VO=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Dw(t)},Mw=function(t,e,n,r){r&&e===void 0||Bf(Kh(t,"value"),e,n)},Bf=function(t,e,n){const r=n instanceof fe?new ux(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+Tr(r));if(typeof e=="function")throw new Error(t+"contains a function "+Tr(r)+" with contents = "+e.toString());if(D0(e))throw new Error(t+"contains "+e.toString()+" "+Tr(r));if(typeof e=="string"&&e.length>yc/3&&eu(e)>yc)throw new Error(t+"contains a string greater than "+yc+" utf8 bytes "+Tr(r)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(wt(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(s=!0,!Lw(o)))throw new Error(t+" contains an invalid key ("+o+") "+Tr(r)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);cx(r,o),Bf(t,a,r),dx(r)}),i&&s)throw new Error(t+' contains ".value" child '+Tr(r)+" in addition to actual children.")}},Fw=function(t,e,n,r){if(!(r&&n===void 0)&&!Dw(n))throw new Error(Kh(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},KO=function(t,e,n,r){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Fw(t,e,n,r)},Hf=function(t,e){if(G(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},GO=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Lw(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!VO(n))throw new Error(Kh(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qO{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function $f(t,e){let n=null;for(let r=0;r<e.length;r++){const i=e[r],s=i.getPath();n!==null&&!Ef(s,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:s}),n.events.push(i)}n&&t.eventLists_.push(n)}function Uw(t,e,n){$f(t,n),jw(t,r=>Ef(r,e))}function On(t,e,n){$f(t,n),jw(t,r=>Vt(r,e)||Vt(e,r))}function jw(t,e){t.recursionDepth_++;let n=!0;for(let r=0;r<t.eventLists_.length;r++){const i=t.eventLists_[r];if(i){const s=i.path;e(s)?(YO(t.eventLists_[r]),t.eventLists_[r]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function YO(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const r=n.getEventRunner();Fr&&rt("event: "+n.toString()),os(r)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const QO="repo_interrupt",JO=25;class XO{constructor(e,n,r,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=r,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new qO,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Sl(),this.transactionQueueTree_=new zf,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function ZO(t,e,n){if(t.stats_=yf(t.repoInfo_),t.forceRestClient_||Lb())t.server_=new Cl(t.repoInfo_,(r,i,s,o)=>{kg(t,r,i,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Rg(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ve(n)}catch(r){throw new Error("Invalid authOverride provided: "+r)}}t.persistentConnection_=new Sn(t.repoInfo_,e,(r,i,s,o)=>{kg(t,r,i,s,o)},r=>{Rg(t,r)},r=>{eA(t,r)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(r=>{t.server_.refreshAuthToken(r)}),t.appCheckProvider_.addTokenChangeListener(r=>{t.server_.refreshAppCheckToken(r.token)}),t.statsReporter_=jb(t.repoInfo_,()=>new Fx(t.stats_,t.server_)),t.infoData_=new Ox,t.infoSyncTree_=new Cg({startListening:(r,i,s,o)=>{let a=[];const l=t.infoData_.getNode(r._path);return l.isEmpty()||(a=vu(t.infoSyncTree_,r._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Kf(t,"connected",!1),t.serverSyncTree_=new Cg({startListening:(r,i,s,o)=>(t.server_.listen(r,s,i,(a,l)=>{const u=o(a,l);On(t.eventQueue_,r._path,u)}),[]),stopListening:(r,i)=>{t.server_.unlisten(r,i)}})}function zw(t){const n=t.infoData_.getNode(new fe(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Vf(t){return MO({timestamp:zw(t)})}function kg(t,e,n,r,i){t.dataUpdateCount++;const s=new fe(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(r){const l=dl(n,u=>Ye(u));o=xO(t.serverSyncTree_,s,l,i)}else{const l=Ye(n);o=bO(t.serverSyncTree_,s,l,i)}else if(r){const l=dl(n,u=>Ye(u));o=RO(t.serverSyncTree_,s,l)}else{const l=Ye(n);o=vu(t.serverSyncTree_,s,l)}let a=s;o.length>0&&(a=wu(t,s)),On(t.eventQueue_,a,o)}function Rg(t,e){Kf(t,"connected",e),e===!1&&nA(t)}function eA(t,e){wt(e,(n,r)=>{Kf(t,n,r)})}function Kf(t,e,n){const r=new fe("/.info/"+e),i=Ye(n);t.infoData_.updateSnapshot(r,i);const s=vu(t.infoSyncTree_,r,i);On(t.eventQueue_,r,s)}function Ww(t){return t.nextWriteId_++}function tA(t,e,n,r,i){Gf(t,"set",{path:e.toString(),value:n,priority:r});const s=Vf(t),o=Ye(n,r),a=Af(t.serverSyncTree_,e),l=bw(o,a,s),u=Ww(t),c=kw(t.serverSyncTree_,e,l,u,!0);$f(t.eventQueue_,c),t.server_.put(e.toString(),o.val(!0),(h,m)=>{const v=h==="ok";v||yt("set at "+e+" failed: "+h);const y=xr(t.serverSyncTree_,u,!v);On(t.eventQueue_,e,y),sA(t,i,h,m)});const d=Kw(t,e);wu(t,d),On(t.eventQueue_,d,[])}function nA(t){Gf(t,"onDisconnectEvents");const e=Vf(t),n=Sl();Dd(t.onDisconnect_,oe(),(i,s)=>{const o=jO(i,s,t.serverSyncTree_,e);hw(n,i,o)});let r=[];Dd(n,oe(),(i,s)=>{r=r.concat(vu(t.serverSyncTree_,i,s));const o=Kw(t,i);wu(t,o)}),t.onDisconnect_=Sl(),On(t.eventQueue_,oe(),r)}function rA(t,e,n){let r;G(e._path)===".info"?r=Sg(t.infoSyncTree_,e,n):r=Sg(t.serverSyncTree_,e,n),Uw(t.eventQueue_,e._path,r)}function Hd(t,e,n){let r;G(e._path)===".info"?r=Wd(t.infoSyncTree_,e,n):r=Wd(t.serverSyncTree_,e,n),Uw(t.eventQueue_,e._path,r)}function iA(t){t.persistentConnection_&&t.persistentConnection_.interrupt(QO)}function Gf(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),rt(n,...e)}function sA(t,e,n,r){e&&os(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let s=i;r&&(s+=": "+r);const o=new Error(s);o.code=i,e(o)}})}function Bw(t,e,n){return Af(t.serverSyncTree_,e,n)||H.EMPTY_NODE}function qf(t,e=t.transactionQueueTree_){if(e||Eu(t,e),as(e)){const n=$w(t,e);x(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&oA(t,Go(e),n)}else Ow(e)&&yu(e,n=>{qf(t,n)})}function oA(t,e,n){const r=n.map(u=>u.currentWriteId),i=Bw(t,e,r);let s=i;const o=i.hash();for(let u=0;u<n.length;u++){const c=n[u];x(c.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),c.status=1,c.retryCount++;const d=ft(e,c.path);s=s.updateChild(d,c.currentOutputSnapshotRaw)}const a=s.val(!0),l=e;t.server_.put(l.toString(),a,u=>{Gf(t,"transaction put response",{path:l.toString(),status:u});let c=[];if(u==="ok"){const d=[];for(let h=0;h<n.length;h++)n[h].status=2,c=c.concat(xr(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&d.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();Eu(t,Wf(t.transactionQueueTree_,e)),qf(t,t.transactionQueueTree_),On(t.eventQueue_,e,c);for(let h=0;h<d.length;h++)os(d[h])}else{if(u==="datastale")for(let d=0;d<n.length;d++)n[d].status===3?n[d].status=4:n[d].status=0;else{yt("transaction at "+l.toString()+" failed: "+u);for(let d=0;d<n.length;d++)n[d].status=4,n[d].abortReason=u}wu(t,e)}},o)}function wu(t,e){const n=Hw(t,e),r=Go(n),i=$w(t,n);return aA(t,i,r),r}function aA(t,e,n){if(e.length===0)return;const r=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],u=ft(n,l.path);let c=!1,d;if(x(u!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)c=!0,d=l.abortReason,i=i.concat(xr(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=JO)c=!0,d="maxretry",i=i.concat(xr(t.serverSyncTree_,l.currentWriteId,!0));else{const h=Bw(t,l.path,o);l.currentInputSnapshot=h;const m=e[a].update(h.val());if(m!==void 0){Bf("transaction failed: Data returned ",m,l.path);let v=Ye(m);typeof m=="object"&&m!=null&&Jt(m,".priority")||(v=v.updatePriority(h.getPriority()));const w=l.currentWriteId,p=Vf(t),f=bw(v,h,p);l.currentOutputSnapshotRaw=v,l.currentOutputSnapshotResolved=f,l.currentWriteId=Ww(t),o.splice(o.indexOf(w),1),i=i.concat(kw(t.serverSyncTree_,l.path,f,l.currentWriteId,l.applyLocally)),i=i.concat(xr(t.serverSyncTree_,w,!0))}else c=!0,d="nodata",i=i.concat(xr(t.serverSyncTree_,l.currentWriteId,!0))}On(t.eventQueue_,n,i),i=[],c&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(d==="nodata"?r.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):r.push(()=>e[a].onComplete(new Error(d),!1,null))))}Eu(t,t.transactionQueueTree_);for(let a=0;a<r.length;a++)os(r[a]);qf(t,t.transactionQueueTree_)}function Hw(t,e){let n,r=t.transactionQueueTree_;for(n=G(e);n!==null&&as(r)===void 0;)r=Wf(r,n),e=me(e),n=G(e);return r}function $w(t,e){const n=[];return Vw(t,e,n),n.sort((r,i)=>r.order-i.order),n}function Vw(t,e,n){const r=as(e);if(r)for(let i=0;i<r.length;i++)n.push(r[i]);yu(e,i=>{Vw(t,i,n)})}function Eu(t,e){const n=as(e);if(n){let r=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[r]=n[i],r++);n.length=r,xw(e,n.length>0?n:void 0)}yu(e,r=>{Eu(t,r)})}function Kw(t,e){const n=Go(Hw(t,e)),r=Wf(t.transactionQueueTree_,e);return WO(r,i=>{wc(t,i)}),wc(t,r),Aw(r,i=>{wc(t,i)}),n}function wc(t,e){const n=as(e);if(n){const r=[];let i=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(x(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(x(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(xr(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&r.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?xw(e,void 0):n.length=s+1,On(t.eventQueue_,Go(e),i);for(let o=0;o<r.length;o++)os(r[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lA(t){let e="";const n=t.split("/");for(let r=0;r<n.length;r++)if(n[r].length>0){let i=n[r];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function uA(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const r=n.split("=");r.length===2?e[decodeURIComponent(r[0])]=decodeURIComponent(r[1]):yt(`Invalid query segment '${n}' in query '${t}'`)}return e}const Pg=function(t,e){const n=cA(t),r=n.namespace;n.domain==="firebase.com"&&xn(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!r||r==="undefined")&&n.domain!=="localhost"&&xn("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||Tb();const i=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new G0(n.host,n.secure,r,i,e,"",r!==n.subdomain),path:new fe(n.pathString)}},cA=function(t){let e="",n="",r="",i="",s="",o=!0,a="https",l=443;if(typeof t=="string"){let u=t.indexOf("//");u>=0&&(a=t.substring(0,u-1),t=t.substring(u+2));let c=t.indexOf("/");c===-1&&(c=t.length);let d=t.indexOf("?");d===-1&&(d=t.length),e=t.substring(0,Math.min(c,d)),c<d&&(i=lA(t.substring(c,d)));const h=uA(t.substring(Math.min(t.length,d)));u=e.indexOf(":"),u>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(u+1),10)):u=e.length;const m=e.slice(0,u);if(m.toLowerCase()==="localhost")n="localhost";else if(m.split(".").length<=2)n=m;else{const v=e.indexOf(".");r=e.substring(0,v).toLowerCase(),n=e.substring(v+1),s=r}"ns"in h&&(s=h.ns)}return{host:e,port:l,domain:n,subdomain:r,secure:o,scheme:a,pathString:i,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yf{constructor(e,n,r,i){this._repo=e,this._path=n,this._queryParams=r,this._orderByCalled=i}get key(){return Q(this._path)?null:nw(this._path)}get ref(){return new Mn(this._repo,this._path)}get _queryIdentifier(){const e=hg(this._queryParams),n=vf(e);return n==="{}"?"default":n}get _queryObject(){return hg(this._queryParams)}isEqual(e){if(e=$(e),!(e instanceof Yf))return!1;const n=this._repo===e._repo,r=Ef(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&r&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+lx(this._path)}}class Mn extends Yf{constructor(e,n){super(e,n,new Tf,!1)}get parent(){const e=iw(this._path);return e===null?null:new Mn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class No{constructor(e,n,r){this._node=e,this.ref=n,this._index=r}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new fe(e),r=qi(this.ref,e);return new No(this._node.getChild(n),r,ke)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(r,i)=>e(new No(i,qi(this.ref,r),ke)))}hasChild(e){const n=new fe(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function $d(t,e){return t=$(t),t._checkNotDeleted("ref"),e!==void 0?qi(t._root,e):t._root}function qi(t,e){return t=$(t),G(t._path)===null?KO("child","path",e,!1):Fw("child","path",e,!1),new Mn(t._repo,Ue(t._path,e))}function hA(t,e){t=$(t),Hf("push",t._path),Mw("push",e,t._path,!0);const n=zw(t._repo),r=dA(n),i=qi(t,r),s=qi(t,r);let o;return e!=null?o=Qw(s,e).then(()=>s):o=Promise.resolve(s),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function fA(t){return Hf("remove",t._path),Qw(t,null)}function Qw(t,e){t=$(t),Hf("set",t._path),Mw("set",e,t._path,!1);const n=new Xl;return tA(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}class Iu{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const r=n._queryParams.getIndex();return new Gw("value",this,new No(e.snapshotNode,new Mn(n._repo,n._path),r))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new qw(this,e,n):null}matches(e){return e instanceof Iu?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class Cu{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new qw(this,e,n):null}createEvent(e,n){x(e.childName!=null,"Child events should have a childName.");const r=qi(new Mn(n._repo,n._path),e.childName),i=n._queryParams.getIndex();return new Gw(e.type,this,new No(e.snapshotNode,r,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Cu?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function pA(t,e,n,r,i){let s;if(typeof r=="object"&&(s=void 0,i=r),typeof r=="function"&&(s=r),i&&i.onlyOnce){const l=n,u=(c,d)=>{Hd(t._repo,t,a),l(c,d)};u.userCallback=n.userCallback,u.context=n.context,n=u}const o=new Yw(n,s||void 0),a=e==="value"?new Iu(o):new Cu(e,o);return rA(t._repo,t,a),()=>Hd(t._repo,t,a)}function mA(t,e,n,r){return pA(t,"value",e,n,r)}function gA(t,e,n){let r=null;const i=n?new Yw(n):null;e==="value"?r=new Iu(i):e&&(r=new Cu(e,i)),Hd(t._repo,t,r)}_O(Mn);SO(Mn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vA="FIREBASE_DATABASE_EMULATOR_HOST",Vd={};let _A=!1;function yA(t,e,n,r){t.repoInfo_=new G0(`${e}:${n}`,!1,t.repoInfo_.namespace,t.repoInfo_.webSocketOnly,t.repoInfo_.nodeAdmin,t.repoInfo_.persistenceKey,t.repoInfo_.includeNamespaceInQueryParams,!0),r&&(t.authTokenProvider_=r)}function wA(t,e,n,r,i){let s=r||t.options.databaseURL;s===void 0&&(t.options.projectId||xn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),rt("Using default host for project ",t.options.projectId),s=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=Pg(s,i),a=o.repoInfo,l,u;typeof process<"u"&&process.env&&(u=process.env[vA]),u?(l=!0,s=`http://${u}?ns=${a.namespace}`,o=Pg(s,i),a=o.repoInfo):l=!o.repoInfo.secure;const c=i&&l?new xi(xi.OWNER):new Mb(t.name,t.options,e);GO("Invalid Firebase Database URL",o),Q(o.path)||xn("Database URL must point to the root of a Firebase Database (not including a child path).");const d=IA(a,t,c,new Db(t.name,n));return new CA(d,t)}function EA(t,e){const n=Vd[e];(!n||n[t.key]!==t)&&xn(`Database ${e}(${t.repoInfo_}) has already been deleted.`),iA(t),delete n[t.key]}function IA(t,e,n,r){let i=Vd[e.name];i||(i={},Vd[e.name]=i);let s=i[t.toURLString()];return s&&xn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new XO(t,_A,n,r),i[t.toURLString()]=s,s}class CA{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(ZO(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Mn(this._repo,oe())),this._rootInternal}_delete(){return this._rootInternal!==null&&(EA(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&xn("Cannot call "+e+" on a deleted database.")}}function Kd(t=Qh(),e){const n=Mo(t,"database").getImmediate({identifier:e});if(!n._instanceStarted){const r=PT("database");r&&SA(n,...r)}return n}function SA(t,e,n,r={}){t=$(t),t._checkNotDeleted("useEmulator"),t._instanceStarted&&xn("Cannot call useEmulator() after instance has already been initialized.");const i=t._repoInternal;let s;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&xn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new xi(xi.OWNER);else if(r.mockUserToken){const o=typeof r.mockUserToken=="string"?r.mockUserToken:NT(r.mockUserToken,t.app.options.projectId);s=new xi(o)}yA(i,e,n,s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
